...
module.exports = {
  ...
  // CONFIG_REGISTRATION_EARLYBIRD_CUTOFF_IN_LOCAL_TIME_IN_MS: "1751349600000",    // 01:00 on July 15th, 2025 (CST)    FIXME: dev only
  ...
  // CONFIG_ANGLER_REGISTRATION_CUTOFF_IN_LOCAL_TIME_IN_MS: "1751349600000",    // 01:00 on July 15th, 2025 (CST)    FIXME: dev only
  // CONFIG_SPONSOR_REGISTRATION_CUTOFF_IN_LOCAL_TIME_IN_MS: "1751349600000",    // 01:00 on July 15th, 2025 (CST)    FIXME: dev only
  CONFIG_REGISTRATION_EARLYBIRD_DATE_STRING:
    "Pre-registration (before July 1st, 2024):",
  ...
  CONFIG_REGISTRATION_NORMAL_DATE_STRING:
    "Normal registration (after July 1st, 2024):",
