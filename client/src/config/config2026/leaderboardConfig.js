  ...
  CONFIG_LEADERBOARD_CATEGORIES: [
    ...
    // Champions
    {
      ...
      desktopColumns: [
        ...
        { field: 'Blue Marlin', headerName: 'Blue Marlin', flex: 1, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'White Marlin', headerName: 'White Marlin', flex: 1, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'Sailfish', headerName: 'Sailfish', flex: 1, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'Tarpon', headerName: 'Tarpon', flex: 1, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'Barracuda', headerName: 'Barracuda', flex: 1, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'Blackfin Tuna', headerName: 'Blackfin Tuna', flex: 1, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'Bonito (Little Tunny)', headerName: 'Bonito', flex: 1, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'Dolphin (Dorado Mahi)', headerName: 'Dolphin', flex: 1, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'Jack Crevalle (Jackfish)', headerName: 'Jack Crevalle', flex: 1, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'King Mackerel (Kingfish)', headerName: 'Kingfish', flex: 1, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'Ling (Cobia)', headerName: 'Ling', flex: 1, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'Blacktip/Spinner Shark', headerName: 'Shark', flex: 1, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'Wahoo', headerName: 'Wahoo', flex: 1, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'Spanish Mackerel', headerName: 'Spanish Mack.', flex: 1, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'Yellowfin Tuna', headerName: 'Yellowfin Tuna', flex: 1, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'Red Snapper', headerName: 'Red Snapper', flex: 1, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'Swordfish', headerName: 'Swordfish', flex: 1, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
      ...
      mobileColumns: [
        ...
        { field: 'Blue Marlin', headerName: 'Blue Mrln', width: 90, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'White Marlin', headerName: 'White Mrln', width: 90, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'Sailfish', headerName: 'Sailfish', width: 90, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'Tarpon', headerName: 'Tarpon', width: 90, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'Barracuda', headerName: 'Barracuda', width: 90, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'Blackfin Tuna', headerName: 'Blkfin Tuna', width: 90, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'Bonito (Little Tunny)', headerName: 'Bonito', width: 90, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'Dolphin (Dorado Mahi)', headerName: 'Dolphin', width: 90, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'Jack Crevalle (Jackfish)', headerName: 'Jack Crev.', width: 90, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'King Mackerel (Kingfish)', headerName: 'Kingfish', width: 90, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'Ling (Cobia)', headerName: 'Ling', width: 80, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'Blacktip/Spinner Shark', headerName: 'Shark', width: 80, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'Wahoo', headerName: 'Wahoo', width: 80, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'Spanish Mackerel', headerName: 'Spn. Mack.', width: 90, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'Yellowfin Tuna', headerName: 'Yllwfin Tuna', width: 90, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'Red Snapper', headerName: 'Red Snapper', width: 90, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
        { field: 'Swordfish', headerName: 'Swordfish', width: 90, headerClassName: 'super-app-theme--header', headerAlign: 'center', align: 'center', isDateTime: false },
